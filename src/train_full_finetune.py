...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output_dir", default="./output/finetuned", help="Where to save the model")
    ...
    p.add_argument("--max_length", type=int, default=512, help="Max sequence length in tokens")
    p.add_argument("--val_split", type=float, default=0.05, help="Fraction of data held out for validation")
    p.add_argument("--seed", type=int, default=42)
    p.add_argument("--hf_token", default=os.environ.get("HF_TOKEN", ""), help="HuggingFace token for gated models")
    ...
    p.add_argument("--num_samples", type=int, default=0, help="Use only this many training samples (0 = all)")
    return p.parse_args()
