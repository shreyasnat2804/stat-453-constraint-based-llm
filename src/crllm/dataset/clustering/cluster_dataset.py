...
def main():
    parser = argparse.ArgumentParser(
        description="Cluster RECAST dataset by constraint type."
    )
    parser.add_argument(
        "--input",
        "-i",
        default=os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "RECAST-30K.json"
        ),
    ...
    parser.add_argument(
        ...
        "-o",
        default=os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "recast_clustered.json"
        ),
